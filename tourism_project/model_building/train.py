...
# Xtrain/Xtest/ytrain/ytest are loaded from artifacts generated by data_prep.py
...
with mlflow.start_run(run_name="Production_Training_Run"):
    ...
    # Save model binary into deployment directory for Streamlit Cloud deployment
